...
class BottomNavigationViewEx : BottomNavigationView {
    ...
    fun setIconVisibility(visibility: Boolean): BottomNavigationViewEx {
        ...
        for (button in mButtons!!) {
            val mIcon =
                getField<ImageView>(button.javaClass, button, "icon")!!
            // 4. set mIcon visibility gone
        ...
        if (!visibility) {
            ...
            if (null != button) {
                ...
                mIcon?.post { //                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
        ...
        for (button in mButtons!!) {
            ...
            if (!enable) {
                if (!animationRecord) {
                    ...
                    mScaleUpFactor =
                        getField<Float>(button.javaClass, button, "scaleUpFactor")!!
                    mScaleDownFactor =
                        getField<Float>(button.javaClass, button, "scaleDownFactor")!!
                    mLargeLabelSize = mLargeLabel.textSize
                    mSmallLabelSize = mSmallLabel.textSize
...
//        mMenuView.updateMenuView();
     ...
     * @return
     */
    fun getOnNavigationItemSelectedListener(): OnNavigationItemSelectedListener {
    ...
    private val bottomNavigationMenuView: BottomNavigationMenuView?
        private get() {
            if (null == mMenuView) mMenuView =
                getField<BottomNavigationMenuView>(
    ...
    val itemCount: Int
        get() {
            val bottomNavigationItemViews =
                bottomNavigationItemViews ?: return 0
    ...
    private class BottomNavigationViewExOnPageChangeListener(bnve: BottomNavigationViewEx) :
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (null != bnve && !isNavigationItemClicking) bnve.setCurrentItem(
                position
            )
